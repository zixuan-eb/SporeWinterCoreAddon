...
public class WinterCorePonderScenes {
    ...
    public static void assembly(SceneBuilder scene, SceneBuildingUtil util) {
        // ── 场景初始化 ──────────────────────────────────────────────────────
        scene.title("winter_core_ponder.assembly", "Assembling the Fimbulwinter Core");
        ...
        scene.overlay.showText(80)
                .text(Component.translatable("ponder.wintercore.winter_core_assembly.step1"))
                .placeNearTarget()
        ...
        scene.overlay.showText(70)
                .text(Component.translatable("ponder.wintercore.winter_core_assembly.step2"))
                .placeNearTarget()
        ...
        scene.overlay.showText(80)
                .text(Component.translatable("ponder.wintercore.winter_core_assembly.step3"))
                .placeNearTarget()
        ...
        scene.overlay.showText(80)
                .text(Component.translatable("ponder.wintercore.winter_core_assembly.step4"))
                .placeNearTarget()
        ...
        scene.overlay.showText(80)
                ...
                .text(Component.translatable("ponder.wintercore.winter_core_assembly.activated"))
                .placeNearTarget()
                .pointAt(util.vector.blockSurface(util.grid.at(4, 3, 4), Direction.UP));
        scene.idle(80);
    }
